...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-0465eb6e');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-0465eb6e');}
...
function clearFlash(){dieView.classList.remove('rl-win-0465eb6e');dieView.classList.remove('rl-lose-0465eb6e');if(frameEl){frameEl.classList.remove('rl-win-0465eb6e');frameEl.classList.remove('rl-lose-0465eb6e');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-0465eb6e');if(frameEl){frameEl.classList.add('rl-win-0465eb6e');}}else{dieView.classList.add('rl-lose-0465eb6e');if(frameEl){frameEl.classList.add('rl-lose-0465eb6e');}}
...
var brandEl=document.querySelector('.rl-brand-0465eb6e');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
